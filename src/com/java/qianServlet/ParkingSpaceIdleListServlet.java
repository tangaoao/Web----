...
@WebServlet(name = "ParkingSpaceIdleListServlet", value = "/ParkingSpaceIdleListServlet")
public class ParkingSpaceIdleListServlet extends HttpServlet {
...
/*        System.out.println("区域"+bianHao+"类别："+leiBie+"区域："+quYu);
        ...
        try{
            ...
            JSONArray jsonArray = JsonUtil.formatRsToJsonArray(parkingSpaceDao.parkingSpaceKong(con,pageBean,parkingSpace));
